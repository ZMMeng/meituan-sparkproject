package com.mzm.sparkproject.test;
...
public class MockData {
    ...
    public static void mock(JavaSparkContext sc, SQLContext sqlContext) {
        ...
        String[] searchKeywords = new String[]{"火锅", "蛋糕", "重庆辣子鸡", "重庆小面", "呷哺呷哺", "新辣道鱼火锅", "国贸大厦",
                "太古商场", "日本料理", "温泉"};
        ...
        for(int i = 0; i < 100; i ++) {
            ...
            Row row = RowFactory.create(String.valueOf(productId), productName, extendInfo);
            rows.add(row);
        }
